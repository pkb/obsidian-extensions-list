...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------: | :------------: | ---------------------------------------------------------------------------------------------------------------- |
| Assign code                               | Assign a code to the current paragraph, any selected text is highlighted. (overlapping highlights not supported though). <br><br>Select `Create new code` or press `shift ⏎` to create a new code file and assign it to the paragraph. |   ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/circle-plus.svg)    | `mod+shift+a`  | Quadro                                                                                                           |
| Rename code                               | All references to the Code File are automatically updated. (You can also rename by right-clicking a file or link and selecting "Rename.")                                                                                              |   ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/circle-slash.svg)   |                | [Obsidian Built-in][rename]                                                                                      |
| Delete code from paragraph                | Removes a code from the current paragraph of a Data File or Code File. The reference is also removed from the corresponding other file.                                                                                                |   ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/circle-minus.svg)   | `mod+shift+d`  | Quadro                                                                                                           |
| Delete Code File and all references to it | Moves the Code File to the trash, _and_ deletes all references to it.                                                                                                                                                                  |     ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/circle-x.svg)     |       —        | Quadro                                                                                                           |
| Bulk-create new codes                     | Create multiple new codes at once (without assigning them to a paragraph).                                                                                                                                                             |  ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/circle-dashed.svg)   |       —        | Quadro                                                                                                           |
| Merge codes                               | Merge the _current_ Code File into another Code File. All references from data files are updated to point to the merged file.                                                                                                          |    ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/circle-dot.svg)    |       —        | Quadro                                                                                                           |
| Code grouping                             | Codes can be arranged in sub-folders via drag-and-drop in the File Explorer.                                                                                                                                                            |                   —                    |       —        | [Obsidian Built-in][move file]                                                                                   |
| Show code overview                        | Creates an auto-updating overview of all codes in a nested list with code assignment counts.                                                                                                                                           |   ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/circle-equal.svg)   |       —        | Quadro                                                                                                           |
| Axial coding                              | Using the Canvas plugins, you can freely arrange entities on a board, and connect them via lines and arrows, suitable for Axial Coding. <br><br>[Further Documentation][core-canvas]                                                   | ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/layout-dashboard.svg) |       —        | [Obsidian Core Plugin: Canvas][core-canvas]<br><br>[Obsidian Community Plugin: Semantic Canvas][semantic-canvas] |
...
| Visualization of code relationships       | In the Graph View, use a query like `path:Codes OR path:Data`, and assign Data and Codes to different groups. <br><br>[Further Documentation][graph]                                                                                   |     ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/git-fork.svg)     |    `mod+g`     | [Obsidian Core Plugin: Graph View][graph]                                                                        |
...
| Action                                | Description                                                                                                                                                                                                                                                                                             |            Sidebar button                 | Default hotkey | Capability provider                                      |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------------------------------:     | :------------: | -------------------------------------------------------- |
| Extract from paragraph                | Creates an Extraction File from Extraction Template.                                                                                                                                                                                                                                                    |   ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/square-plus.svg)       | `mod+shift+e`  | Quadro                                                   |
| Add paragraph to last Extraction File | Adds a reference to the last modified Extraction file to the current paragraph. Useful when information is spread across to paragraphs.                                                                                                                                                                 |   ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/square-asterisk.svg)   | `mod+shift+l`  | Quadro                                                   |
| Merge extractions                     | Merge the _current_ Extraction File into another Extraction File. All references from data files are updated to point to the merged file.                                                                                                                                                               |     ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/square-dot.svg)      |       —        | Quadro                                                   |
| Create new extraction type            | Creates a new Extraction Type (= a new sub-folder in "Extractions," alongside a new Extraction Template).                                                                                                                                                                                               |   ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/box-select.svg)        |       —        | Quadro                                                   |
| Show Extraction type overview         | Creates an auto-updating overview of an Extraction Type and their values.                                                                                                                                                                                                                               |  ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/square-equal.svg)       |       —        | Quadro                                                   |
...
| Export all extractions as `.csv`      | All extractions for all extraction types are exported as `.csv`.                                                                                                                                                                                                                                        | ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/square-arrow-up.svg)     |       —        | Quadro                                                   |
...
| -------------------------------- | ----------------------------------------------------------------------------- | :------------------------------------: | :------------: |
| Open random unread Data File     | Open a random file in the vault that has the property `read` set to `false`   |   ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/shuffle.svg)    | `mod+shift+n`  |
...
| Action                           | Description                                                                               |                Sidebar button                 | Default hotkey |
| -------------------------------- | ----------------------------------------------------------------------------------------- | :-------------------------------------------: | :------------: |
| Mark current Data File as read   | Sets a property `read` for the current file to `true` and increments the `progress.json`. |     ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/file-check.svg)      | `mod+shift+r`  |
| Show data analysis progress file | Reveals the `progress.json` file in the system explorer.                                  | ![Icon](https://raw.githubusercontent.com/chrisgrieser/obsidian-quadro/HEAD/docs/icons/flag-triangle-right.svg) |                |
