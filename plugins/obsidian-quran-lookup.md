...
- QuranLookup
author:
- '[[authors/abuibrahim2|AbuIbrahim2]]'
categories: []
...
![obsidian quran lookup range](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/quran-lookup-range.gif)
...
![obsidian quran lookup range](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/quran-lookup-chained.gif)

- Searching for verses with a specific word or phrase in a translation
![obsidian quran lookup search](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/translation-search.png)

- Searching for verses with a specific word or phrase in the Arabic text
![obsidian quran lookup arabic search](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/arabic-search.png)

- Using the draggable Arabic floating keyboard to insert Arabic text
![obsidian quran lookup keyboard](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/draggable-ar-keyboard.png)
...
![obsidian quran lookup settings](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/Quran_Lookup_Settings.png)
...
![obsidian quran remove paren](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/quran-lookup-remove-paren.png)
...
![text only](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/Quran_Text_Only.png)
...
![text only](https://raw.githubusercontent.com/abuibrahim2/quranlookup/HEAD//docs/Quran_Markdown_Table.png)
